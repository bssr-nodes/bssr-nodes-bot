        ...
        Axios({
            ...
            .then(async (Response) => {
                ...
                client.users.cache
                    ...
                    .send(`New password for BSSR Nodes: ||**${data.password}**||`).catch((Error) => console.log("[PASSWORD RESET] User does not have direct messages enabled."));

                //Formatting the email message.
                const EmailMessage = {
                    from: Config.Email.From,
                    to: data.email,
                    subject: "BSSR Nodes - Password Reset From Discord Bot",
                    html:
                ...
                await sendMail(data.email, "BSSR Nodes - Password Reset From Discord Bot", EmailMessage.html).catch((Error) => {            
