...
exports.run = async (client, message, args) => {
    ...
    let category = message.guild.channels.cache.find((c) => c.id === "1250359312249917501" && c.type === "category");
    ...
    axios({
        ...
        .then((user) => {
            ...
            message.guild.members.cache.get(message.author.id).roles.add("1250744275566592033");
            setTimeout(function () {
                channel.delete();
            }, 1800000);
        })
